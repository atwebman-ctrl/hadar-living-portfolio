...
// ============================================================
// HebrewCompositionSectionWrapper.tsx
//
// Client wrapper around <SectionEditorShell> + <CompositionSection>
// for the Hebrew composition section. Mirrors MAPSSectionWrapper.
// ============================================================
...
export default function HebrewCompositionSectionWrapper({
  ...
  return (
    <SectionEditorShell
      ...
      termLabel={termLabel}
      sectionTitle={PROFILE_SECTION_KIND_LABELS.hebrew_composition}
