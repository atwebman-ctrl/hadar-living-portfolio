...
// ============================================================
// AVANTSectionWrapper.tsx
//
// Client wrapper around <SectionEditorShell> + <AVANTSection>.
// Owns local narrative state, dispatches PATCH calls, and
// supplies the AI draft stub. Mirrors MAPSSectionWrapper.
// ============================================================
...
export default function AVANTSectionWrapper({
  profileId, sectionId, initialNarrative, initialStatus,
  studentName, gradeLabel, termLabel, backHref, assessments,
}: Props) {
  ...
  return (
    <SectionEditorShell
      ...
      termLabel={termLabel}
      sectionTitle={PROFILE_SECTION_KIND_LABELS.avant_hebrew}
