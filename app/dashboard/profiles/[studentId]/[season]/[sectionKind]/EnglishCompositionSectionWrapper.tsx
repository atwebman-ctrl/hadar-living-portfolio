...
// ============================================================
// EnglishCompositionSectionWrapper.tsx
//
// Client wrapper around <SectionEditorShell> + <CompositionSection>
// for the English composition section. Mirrors MAPSSectionWrapper.
// ============================================================
...
export default function EnglishCompositionSectionWrapper({
  profileId, sectionId, initialNarrative, initialStatus,
  studentName, gradeLabel, termLabel, backHref, samples,
}: Props) {
  ...
  return (
    <SectionEditorShell
      ...
      termLabel={termLabel}
      sectionTitle={PROFILE_SECTION_KIND_LABELS.english_composition}
