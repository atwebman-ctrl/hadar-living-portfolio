...
// ============================================================
// MAPSSectionWrapper.tsx
//
// Client wrapper around <SectionEditorShell> + <MAPSSection>.
// Owns local narrative state, dispatches PATCH calls, and
// supplies the AI draft stub. Mirrors LexileSectionWrapper.
// ============================================================
...
export default function MAPSSectionWrapper({
  ...
  return (
    <SectionEditorShell
      ...
      termLabel={termLabel}
      sectionTitle={PROFILE_SECTION_KIND_LABELS.maps_scores}
