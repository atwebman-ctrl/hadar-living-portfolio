...
// ============================================================
// ReadingListSectionWrapper.tsx
//
// Client wrapper around <SectionEditorShell> + <ReadingListSection>.
// Owns local narrative state, dispatches PATCH calls, supplies
// the AI draft stub. Mirrors the other section wrappers.
// ============================================================
...
export default function ReadingListSectionWrapper({
  profileId, sectionId, initialNarrative, initialStatus,
  studentName, gradeLabel, termLabel, backHref, readings,
}: Props) {
  ...
  return (
    <SectionEditorShell
      ...
      termLabel={termLabel}
      sectionTitle={PROFILE_SECTION_KIND_LABELS.canon_reading}
